...
function Mascot({ sleepy = false }: { sleepy?: boolean }) {
  return (
    <div className="mascot" aria-hidden="true">
      <span className="mascot-handle mascot-handle--tl" />
      <span className="mascot-handle mascot-handle--tr" />
      <span className="mascot-handle mascot-handle--bl" />
      <span className="mascot-handle mascot-handle--br" />
